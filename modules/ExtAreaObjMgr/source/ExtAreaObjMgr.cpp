...
kmWrite32(0x80071318, 0x3860017C + cModuleCreateAreaObjMgrTableCount*4); // li r3, 0x17C + cNumNewMgrs*4
kmWrite32(0x80071320, 0x3800005F + cModuleCreateAreaObjMgrTableCount); // li r0, 0x5F + cNumNewMgrs
