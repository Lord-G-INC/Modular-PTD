...
kmWrite32(0x804712C4, PPC_B(0x10)); // b 0x10
...
kmWrite32(0x80487504+REGIONOFF, PPC_NOP); // nop (Skip overwriting r3)
...
kmWrite32(0x80487560+REGIONOFF, PPC_MR(3, 31)); // mr r3, r31 (PauseMenuExt* into r3)
...
kmWrite32(0x804877B4+REGIONOFF, PPC_MR(3, 27)); // mr r3, r27 (PauseMenuExt* into r3)
...
kmWrite32(0x80487C4C+REGIONOFF, PPC_MR(3, 31)); // mr r3, r31 (PauseMenuExt* into r4)
...
kmWrite32(0x80487B10+REGIONOFF, PPC_MR(3, 30)); // mr r3, r30 (PauseMenuExt* into r3)
...
kmWrite32(0x804879C8+REGIONOFF, PPC_MR(3, 30)); // mr r3, r30
...
kmWrite32(0x804879B0+REGIONOFF, PPC_MR(3, 30)); // mr r3, r30
kmCall(0x804879B4+REGIONOFF, PauseMenuValidateButton);
kmWrite32(0x804879B8+REGIONOFF, PPC_CMPWI(3, 0)); // cmpwi r3, 0
kmWrite32(0x804879BC+REGIONOFF, PPC_COND_BRANCH(PPC_COND_EQ, 0x80)); // beq 0x80
kmWrite32(0x804879C0+REGIONOFF, PPC_B(0x8)); // b 0x8
...
kmWrite32(0x80487A00+REGIONOFF, PPC_MR(3, 30)); // mr r3, r30 (PauseMenuExt* into r3)
kmCall(0x80487A04+REGIONOFF, IsNewButtonDecidedWait);

kmWrite32(0x80487A3C+REGIONOFF, PPC_LWZ(3, 0x34, 30)); // lwz r3, 0x34(r30)
...
kmWrite32(0x80487CA4+REGIONOFF, PPC_MR(4, 3)); // mr r4, r3 (isValid into r4)
kmWrite32(0x80487CA8+REGIONOFF, PPC_MR(3, 31)); // mr r3, r31 (PauseMenuExt* into r3)
kmCall(0x80487CAC+REGIONOFF, DoNewButtonAction);
kmWrite32(0x80487CB0+REGIONOFF, PPC_B(0x8)); // b 0x8 (Skip useless instructions)
...
kmWrite32(0x80487640+REGIONOFF, PPC_NOP); // nop
kmWrite32(0x80487644+REGIONOFF, PPC_MR(3, 30)); // mr r3, r30
...
kmWrite32(0x804876C0+REGIONOFF,PPC_MR(3, 30)); // mr r3, r30
...
kmWrite32(0x80487714+REGIONOFF, PPC_MR(3, 27)); // mr r3, r27 (PauseMenuExt* into r3)
